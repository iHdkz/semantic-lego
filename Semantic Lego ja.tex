...
\newpage
\lstinputlisting[style=centering, caption=部品的インタプリタ 第一部, label=fig1.16]{figure1.16_Modular_interpreter_part1.scm}
\newpage
\lstinputlisting[style=centering, caption=部品的インタプリタ 第二部, label=fig1.17]{figure1.17_Modular_interpreter_part2.scm}
\newpage
...
\lstinputlisting[style=centering, caption=単一化された、パラメータによって指定されるシステム, label=fig1.25]{figure1.25_Unified_system_of_parametrization.scm}
